;(function (global, factory) {
  ...
  function network(selector) {
    ...
    var simulation = d3Force.forceSimulation().force(
      "link",
      d3Force
        .forceLink()
        .distance(function (d) {
    ...
    function networkLayout(_ref) {
      ...
      function draw(nodes, links, accessors) {
        ...
        var graphNodesData = graphNodesGroup
          .selectAll("g")
        ...
        var graphNodesEnter = graphNodesData
          .enter()
          .append("g")
          .attr("id", function (d) {
        ...
        textChildrenNode
          ...
          .attr("font-size", "".concat(nodeTextSize, "px"))
        ...
        textRootNode
          ...
          .attr("font-size", "".concat(nodeTextSize * 2, "px"))
          .attr("text-anchor", "middle")
          .attr("fill", graphEle.nodeTextFill)
          .attr("opacity", 1)
          .attr("x", function (d) {
        ...
        var graphLinksData = graphLinksGroup
          .selectAll("g")
        ...
        var graphLinksEnter = graphLinksData
          .enter()
          .append("g")
          .attr("id", function (d) {
        ...
        graphLinksEnter
          ...
          .attr("font-size", "".concat(linkTextSize, "px"))
          .attr("text-anchor", "middle")
          .attr("fill", graphEle.linkTextFill)
          .attr("opacity", linkTextOpacity)
          .attr("dy", -2)
          .append("textPath")
        ...
        function highlightConnections(graphNodesData, graphLinksData, d, hoverAttr) {
          ...
          function isConnected(a, b) {
            return (
              linkedByIndex["".concat(a.id, ",").concat(b.id)] ||
              linkedByIndex["".concat(b.id, ",").concat(a.id)] ||
              a.id === b.id
            )
          }
      ...
      function updateAttributes(nodes, links) {
        ...
        var linksTarget_nested = d3Collection
          .nest()
          .key(function (d) {
            return d.end_id
          })
          ...
          .entries(links)
        var linksSource_nested = d3Collection
          .nest()
          .key(function (d) {
            return d.start_id
          })
        ...
        var strengthScale = d3Scale
          .scaleLinear()
          .domain(
            d3Array.extent(linkAllNodes, function (d) {
              return d.value
            })
          )
          .range([0.4, 0.3]) // create custom link distance scale based on node type

        var distanceScale = d3Scale
          .scaleOrdinal()
